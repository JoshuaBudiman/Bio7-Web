            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="school" class="col-md-4 col-form-label text-md-right">{{ __('Sekolah Asal') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="birthyear" class="col-md-4 col-form-label text-md-right">{{ __('Tahun Kelahiran') }}</label>
